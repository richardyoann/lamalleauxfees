...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'lamalleauxfees', 'user' => 'root', 'password' => 'Dadounda22!', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.1), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a5ac02f52ac3f64dfe561b767c188c89fd8d9b9f50f5385ff7df0576de447789');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('8EX9ZjP9Qf5u5hze6SJun4IFCy1FMPSLmvY9MkmdCiuvwLN4fZ7SbFPS');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59c937c48ed211.42053513')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => '',
            'database_name' => 'lamalleauxfees',
            'database_user' => 'root',
            'database_password' => 'Dadounda22!',
            'database_prefix' => 'ps_',
            ...
            'secret' => '8EX9ZjP9Qf5u5hze6SJun4IFCy1FMPSLmvY9MkmdCiuvwLN4fZ7SbFPS',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2017-09-22',
            'locale' => 'fr-FR',
            'cookie_key' => 'srDNNWrueoyS2U55diUeY6tLW8wEjTkTBakDO5UntQ5NuInm0mLcRF1X',
            'cookie_iv' => 'yuU2Q9ae',
            'new_cookie_key' => 'def00000bee638197d8aaa0f7660e3af3fedc74ef383a32397c65209da6eb944f1da3296ec13ad51d46e2d24fd5090c979d1a232a923e2bbb984a6d9f1068d8590abcc06',
            ...
            'kernel.secret' => '8EX9ZjP9Qf5u5hze6SJun4IFCy1FMPSLmvY9MkmdCiuvwLN4fZ7SbFPS',
